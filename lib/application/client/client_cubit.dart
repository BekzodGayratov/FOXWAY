...
class ClientCubit extends Cubit<ClientState> {
  ...
  Future<void> getProducts() async {
    ...
    try {
      ...
      emit(ClientState.error(e.message.toString()));
    }
  }

  ///

  Future< DocumentSnapshot<Object?>?> postClient(PostClientModel rentModel) async {
    final response = await _productsFireStoreService.writeClient(rentModel);
  ...
  Future<void> updateClient(
      {required String id,
      required ClientModel rentModel}) async {
    await _productsFireStoreService.updateClient(
        id: id, clientModel: rentModel);
    // calculateTotalPrice();
    // calculateTotalPaidDept();
    // calculateTotalDept();
  }
